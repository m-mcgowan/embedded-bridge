...
class TestMemoryTracker:
    def test_before_and_after_paired(self):
        ...
        mt.feed(_crc("ETST:MEM:BEFORE free=200000 min=180000"))
        mt.feed(_crc("ETST:MEM:AFTER free=199000 delta=-1000 min=179000"))
    ...
    def test_leaks_filters_by_threshold(self):
        ...
        mt.feed(_crc("ETST:MEM:BEFORE free=200000 min=180000"))
        mt.feed(_crc("ETST:MEM:AFTER free=199500 delta=-500 min=179500"))

        mt.set_current_test("Suite/leaky_test")
        mt.feed(_crc("ETST:MEM:BEFORE free=200000 min=180000"))
        mt.feed(_crc("ETST:MEM:AFTER free=195000 delta=-5000 min=175000"))
    ...
    def test_positive_delta_not_a_leak(self):
        ...
        mt.feed(_crc("ETST:MEM:BEFORE free=190000 min=180000"))
        mt.feed(_crc("ETST:MEM:AFTER free=195000 delta=5000 min=180000"))
        assert mt.leaks == {}
    ...
    def test_report_formats_leaks(self):
        ...
        mt.feed(_crc("ETST:MEM:BEFORE free=200000 min=180000"))
        mt.feed(_crc("ETST:MEM:AFTER free=188000 delta=-12000 min=170000"))
    ...
    def test_multiple_tests_tracked(self):
        ...
        mt.feed(_crc("ETST:MEM:BEFORE free=199000 min=179000"))
        mt.feed(_crc("ETST:MEM:AFTER free=198000 delta=-1000 min=178000"))
    ...
    def test_bytes_input(self):
        mt = MemoryTracker()
        mt.set_current_test("Suite/test")
        mt.feed(_crc("ETST:MEM:BEFORE free=200000 min=180000").encode())
        assert mt.all_tests["Suite/test"].free_before == 200000

    def test_no_crc_accepted(self):
        mt = MemoryTracker()
        mt.set_current_test("Suite/test")
        mt.feed("ETST:MEM:BEFORE free=200000 min=180000")
        assert mt.all_tests["Suite/test"].free_before == 200000
