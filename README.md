...
| **WebSocketTransport (Python)** | — | [README](#connect-via-websocket-bridge) | [websocket.py](python/src/embedded_bridge/transport/websocket.py) | [test_websocket](python/tests/test_websocket_transport.py), [integration](python/tests/integration/test_websocket_transport_integration.py) | 0.2.0 | 2026-04-23 |
